...
public class ClientPostsController : ControllerBase
{
    ...
    public ClientPostsController(IClientPostReadOnlyRespository clientPostReadOnlyRespository,
        IClientPostReadWriteRespository clientPostReadWriteRespository, IMapper mapper,
    ...
    public async Task<IActionResult> GetParentPost(Guid id, CancellationToken cancellationToken)
    {
        ...
        {
            var result = (PostMainDTO)vm.Data;
            return Ok(result);
        }
    ...
    public async Task<IActionResult> GetChildPosts([FromQuery] PostIdRequestWithPagination request,
        CancellationToken cancellationToken)
    {
        ...
        if (vm.Success)
        {
            var result = (PaginationResponse<PostMainDTO>)vm.Data;
            return Ok(result);
        }
    ...
    public async Task<IActionResult> GetPostsByMajorId([FromQuery] ClientPostListRequest request,
        CancellationToken cancellationToken)
    {
    ...
    [HttpGet("getMajor")]
    public async Task<IActionResult> GetMajor([FromQuery] ClientPostMajorRequestWithPagination request,
        CancellationToken cancellationToken)
    {
    ...
    {
        ClienPostMajorRequestCreateViewModel vm = new(_clientPostReadOnlyRespository, _clientPostReadWriteRespository,
            _mapper, _localizationService);
        await vm.HandleAsync(request, cancellationToken);
        return Ok(vm);
    }

    [HttpGet("getPostTags")]
    public async Task<IActionResult> GetPostTagsByPostId([FromQuery] PostIdRequestWithPagination request,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> GetMajorsByUserId([FromQuery] GetMajorByUserIdWithPaginationRequest request,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> GetPostBySearchAsync([FromQuery] ClientPostSearchWithPaginationRequest request,
        CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> GetAllListTags(CancellationToken cancellationToken)
    {
        ...
        if (vm.Success)
        {
            var lstTags = (List<TagBaseDTO>)vm.Data;
            return Ok(lstTags);
        }
