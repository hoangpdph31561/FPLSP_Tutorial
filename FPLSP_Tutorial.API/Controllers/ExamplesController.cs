...
public class ExamplesController : ControllerBase
{
    ...
    public ExamplesController(IExampleReadOnlyRepository exampleReadOnlyRepository,
        IExampleReadWriteRepository exampleReadWriteRepository, IConfiguration configuration,
    ...
    [HttpGet]
    public async Task<IActionResult> Get([FromQuery] ViewExampleWithPaginationRequest request,
    ...
    {
        ExampleCreateViewModel vm = new(_exampleReadOnlyRepository, _exampleReadWriteRepository, _localizationService,
            _mapper);
