...
namespace FPLSP_Tutorial.Application.Interfaces.Repositories.ReadOnly
{
    ...
    {
        Task<RequestResult<PaginationResponse<UserDTO>>> GetUserAsync(UserViewRequest request, CancellationToken cancellationToken);
        Task<RequestResult<PaginationResponse<UserDTO>>> GetUserWithPaginationAsync(UserViewWithPaginationRequest request, CancellationToken cancellationToken);
