...
public static class LocalizationString
{
    public static class Common
    {
        ...
        public const string MaxLengthField =
            "The length of {PropertyName} must be {MaxLength} characters or fewer. You entered {TotalLength} characters";

        public const string MinLengthField =
            "The length of {PropertyName} must be at least {MaxLength} characters. You entered {TotalLength} characters";
    ...
    public static class Account
    {
        ...
        public const string AccountIsNotPendingConfirmation =
            "Your account is not pending for your confirmation, you can not activate Account";

        public const string PhoneNumberOrPasswordIncorrectWithLockoutEnabled =
            "Phone Number or password is incorrect ({0} times left)";

        public const string UserNameOrPasswordIncorrectWithLockoutEnabled =
            "User name or password is incorrect ({0} times left)";
        ...
        public const string LockedOutAffected =
            "You account is temporarily being locked out, it will be unlocked at {0}";
        ...
        public const string ChangePasswordNotRequired =
            "It seems you are not required to use this function to change password, please use change password function";
    ...
    public static class Department
    {
        ...
        public const string SelftReferenced =
            "Your being updated Department is not allowed to set its parent as its children, try other ids";
    }
    ...
    {
        public const string UniqueCharsField =
            "The number character of {PropertyName} must be at least {UniqueCharacterRequired} unique characters. You entered {TotalUniqueCharacter} unique characters";

        public const string NonAlphanumericField =
            "The {PropertyName} required special characters. Your password do not have special characters. Please try again";

        public const string LowerCaseField =
            "The {PropertyName} must have at least one lowercase ('a'-'z'). Please try again";

        public const string UpperCaseField =
            "The {PropertyName} must have at least one uppercase ('A'-'Z'). Please try again";
