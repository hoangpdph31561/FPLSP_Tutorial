...
public class RequestResult<TDataType> : IRequest<Unit>
{
    ...
    /// <param name="data"></param>
    /// <returns></returns>
    public static RequestResult<TDataType> Fail(string? message, IEnumerable<ErrorItem>? errors = null,
    ...
    {
        throw new UnauthorizedException(nameof(RequestResult<TDataType>), nameof(UnauthorizedException), message,
            tracker);
