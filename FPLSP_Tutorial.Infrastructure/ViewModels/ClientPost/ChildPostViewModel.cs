...
public class ChildPostViewModel : ViewModelBase<PostIdRequestWithPagination>
{
    ...
    public ChildPostViewModel(IClientPostReadOnlyRespository clientPostReadOnlyRespository,
    ...
    public override async Task HandleAsync(PostIdRequestWithPagination request, CancellationToken cancellationToken)
    {
        try
        {
