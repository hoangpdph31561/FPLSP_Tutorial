...
public class ClienPostMajorRequestCreateViewModel : ViewModelBase<InputMajorRequest>
{
    ...
    public ClienPostMajorRequestCreateViewModel(IClientPostReadOnlyRespository clientPostReadOnlyRespository,
    ...
    public override async Task HandleAsync(InputMajorRequest request, CancellationToken cancellationToken)
    {
        ...
        {
            var createResult =
                await _clientPostReadWriteRespository.AddMajorRequest(_mapper.Map<MajorRequestEntity>(request),
                    cancellationToken);
