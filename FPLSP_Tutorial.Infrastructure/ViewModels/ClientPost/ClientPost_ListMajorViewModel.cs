...
public class ClientPost_ListMajorViewModel : ViewModelBase<ClientPostMajorRequestWithPagination>
{
    ...
    public ClientPost_ListMajorViewModel(IClientPostReadOnlyRespository clientPostReadOnlyRespository, IMapper mapper,
    ...
    public override async Task HandleAsync(ClientPostMajorRequestWithPagination request,
