...
public class GetPostSearchWithPaginationViewModel : ViewModelBase<ClientPostSearchWithPaginationRequest>
{
    ...
    public GetPostSearchWithPaginationViewModel(IClientPostReadOnlyRespository clientPostReadOnly,
    ...
    public override async Task HandleAsync(ClientPostSearchWithPaginationRequest request,
