...
public class MajorByUserIdViewModel : ViewModelBase<GetMajorByUserIdWithPaginationRequest>
{
    ...
    public MajorByUserIdViewModel(IClientPostReadOnlyRespository clientPostReadOnlyRespository,
    ...
    public override async Task HandleAsync(GetMajorByUserIdWithPaginationRequest request,
