...
public class MajorUpdateViewModel : ViewModelBase<MajorUpdateRequest>
{
    ...
    public MajorUpdateViewModel(IMajorReadWriteRepository majorReadWriteRepository,
    ...
    public override async Task HandleAsync(MajorUpdateRequest request, CancellationToken cancellationToken)
    {
        ...
        {
            var result =
                await _majorReadWriteRepository.UpdateMajorAsync(_mapper.Map<MajorEntity>(request), cancellationToken);
