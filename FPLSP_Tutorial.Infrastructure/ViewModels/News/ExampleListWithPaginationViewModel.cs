...
public class ExampleListWithPaginationViewModel : ViewModelBase<ViewExampleWithPaginationRequest>
{
    ...
    public ExampleListWithPaginationViewModel(IExampleReadOnlyRepository ExampleReadOnlyRepository,
    ...
    public override async Task HandleAsync(ViewExampleWithPaginationRequest request,
        CancellationToken cancellationToken)
    {
        try
        {
            var result =
                await _exampleReadOnlyRepository.GetExampleWithPaginationByAdminAsync(request, cancellationToken);
