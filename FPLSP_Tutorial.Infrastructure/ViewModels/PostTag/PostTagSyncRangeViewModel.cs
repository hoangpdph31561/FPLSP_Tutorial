...
namespace FPLSP_Tutorial.Infrastructure.ViewModels.PostTag
{
    public class PostTagSyncRangeViewModel : ViewModelBase<PostTagSyncRangeRequest>
    {
        ...
        public PostTagSyncRangeViewModel(IPostTagReadWriteRepository postTagReadWriteRespository, ILocalizationService localizationService, IMapper mapper)
        {
        ...
        public async override Task HandleAsync(PostTagSyncRangeRequest request, CancellationToken cancellationToken)
        {
            try
            {
                var result = await _postTagReadWriteRespository.SyncRangeAsync(request.PostId, _mapper.Map<List<TagEntity>>(request.ListTag), cancellationToken);
