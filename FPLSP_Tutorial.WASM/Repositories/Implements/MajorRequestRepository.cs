...
namespace FPLSP_Tutorial.WASM.Repositories.Implements
{
    public class MajorRequestRepository : IMajorRequestRepository
    {
        ...
        public async Task<PaginationResponse<MajorRequestDTO>> GetListWithPaginationAsync(MajorRequestViewWithPaginationRequest request)
        {
            string url = $"/api/MajorRequests/GetListWithPagination?PageNumber={request.PageNumber}&PageSize={request.PageSize}";
